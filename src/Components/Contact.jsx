...
const Contact = () => {
  return (
    <section className="bg-base-100 py-10 text-base-content transition-colors duration-300">
      <div className="container px-6 py-12 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
            ...
            ].map(({ title, desc, value, icon }, i) => (
              <div key={i}>
                <span className="inline-block p-3 text-primary rounded-full bg-primary/10">
                  <svg
          ...
          {/* Contact Form */}
          <div className="p-4 py-6 rounded-lg bg-base-200 md:p-8">
            <form>
